...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_PLUS_EQUAL] = ACTION_TAP_DANCE_DOUBLE(KC_PLUS, KC_EQUAL),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [MAC_BASE] = LAYOUT_ansi_82(
        ...
        TD(TD_BACKTICK_TILDE),   TD(TD_ONE_EXCLAMATION),     TD(TD_TWO_AT),     TD(TD_THREE_HASH),     TD(TD_FOUR_DOLLAR),     TD(TD_FIVE_PERCENT),     TD(TD_SIX_CARET),     TD(TD_SEVEN_AMPERSAND),     TD(TD_EIGHT_ASTERISK),     TD(TD_NINE_OPENPAR),     TD(TD_ZERO_CLOSEPAR),     TD(TD_MINUS_UNDERSCORE),  TD(TD_PLUS_EQUAL),   KC_BACKSPACE,            KC_PGUP,
        ...
        KC_LCTL,  KC_LOPTN, KC_LCMMD,                               KC_SPC,                                 MO(VIM_COMMAND),MO(MAC_FN),MO(VIM_INSERT),  KC_LEFT,  KC_DOWN,  KC_RGHT),
...
// this is a '', and this is another 'test'
